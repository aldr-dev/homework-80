...
insert into inventories.categories (id, title, description)
...
insert into inventories.locations (id, title, description)
...
insert into inventories.items (id, category_id, location_id, title, description, image, created_at)
